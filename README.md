...
DB_USER = PASTE_YOUR_DATABASE_USER_NAME

DB_HOST= PASTE_YOUR_DATABASE_URL

DB_NAME= PASTE_YOUR_DATABASE_NAME

DB_PASSWORD= PASTE_YOUR_DATABASE_PASSWORD

DB_PORT= PASTE_YOUR_DATABASE_PORT
```
